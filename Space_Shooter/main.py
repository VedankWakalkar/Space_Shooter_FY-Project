...
# Load images
RED_SPACE_SHIP = pygame.image.load(os.path.join("assets", "Red_ships.png"))
...
YELLOW_LASER = pygame.image.load(os.path.join("assets", "pixel_laser.png"))
...
def main():
    ...
    def redraw_window():
        ...
        #music
        # pygame.mixer.init()
        # pygame.mixer.music.load("win.mp3.mp3")
